...
def main():
    ...
    model.add(Dense(len(train_generator.class_indices.keys()), activation="softmax"))
    ...
    # Only use the validate_generator on your final validation!
    print_results(model, test_generator)
